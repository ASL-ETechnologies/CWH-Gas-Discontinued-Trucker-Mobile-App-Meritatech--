        ...
        implements View.OnClickListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String [] menuItems = {"Invoice One", "Invoice Two", "Invoice Three"};
        ListView lv = (ListView) view.findViewById(R.id.list_view_invoice);
        android.widget.ArrayAdapter<String> listViewAdapter = new android.widget.ArrayAdapter<String>(
                getActivity(),
                android.R.layout.simple_list_item_1,
                menuItems
        );
        lv.setAdapter(listViewAdapter);
        Button b = (Button) view.findViewById(R.id.buttonCreateInvoice);

...
/*    public static ArrayList<CustomerRecord> GetCustomers(String totalItemCount) {
        ...
        ArrayList<CustomerRecord> result = (ArrayList<CustomerRecord>) CustomerRecord.findWithQuery(CustomerRecord.class, "Select * from CUSTOMER_RECORD where CUSTOMER_ID > ? ORDER BY CUSTOMER_ID LIMIT 20", totalItemCount);
        return result;
    }*/
